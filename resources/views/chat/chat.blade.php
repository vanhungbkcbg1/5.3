                    ...
                    <div class="direct-chat-messages" id="direct-chat-messages">
                        ...
                        <div class="direct-chat-msg">
                            ...
                            <img class="direct-chat-img"
                                 src="{{asset('/bower_components/AdminLTE/dist/img/user1-128x128.jpg')}}"
                    ...
                    <form action="#" method="post">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                            <button id="btn_send" type="button" class="btn btn-warning btn-flat">Send</button>
                          </span>
                        </div>
                    </form>
                </div>
...
@section('content_hidden')
    ...
    <div style="display: none;">
        <div class="direct-chat-msg" id="content_hidden">
            <div class="direct-chat-info clearfix">
        ...
        <div class="direct-chat-msg right" id="content_right">
            <div class="direct-chat-info clearfix">
                <span class="direct-chat-name pull-right">Sarah Bullock</span>
                <span class="direct-chat-timestamp pull-left">23 Jan 2:05 pm</span>
            </div>
